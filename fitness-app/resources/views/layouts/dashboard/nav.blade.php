<nav class="bg-white shadow">
    <div class="container mx-auto px-4 py-4 flex justify-between items-center">
        <div class="flex items-center space-x-8">
            ...
            <a href="{{ route('food.index') }}" target="_blank" class="text-gray-600 hover:text-primary">My Food</a>
            <a href="{{ route('dashboard.food') }}" target="_blank" class="text-gray-600 hover:text-primary">Food</a>
